...
be a scalar containing an error message (if an error occured) or a hashref
...
Please report any bugs or feature requests to C<bug-poe-component-app-pngcrush at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-App-PNGCrush>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-App-PNGCrush>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-App-PNGCrush>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-App-PNGCrush>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-App-PNGCrush>
